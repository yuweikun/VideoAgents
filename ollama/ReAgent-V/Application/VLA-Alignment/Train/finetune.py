...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    print(f"Chosen Data Length: {data_length}")
    print(f"Rejected Data Length: {episode_rejected.__len__()}")
    ...
    # only count for train split - using zip to process both iterators together
    for item_s, item_f in zip(episode_chosen_iter, episode_rejected_iter):
    ...
    with tqdm.tqdm(total=cfg.max_steps, leave=False) as progress:
        ...
        for epoch in range(cfg.epoch):
            ...
            if distributed_state.is_main_process:
                ...
                directory_name=f"d1121_check_epoch_{epoch+1}"
