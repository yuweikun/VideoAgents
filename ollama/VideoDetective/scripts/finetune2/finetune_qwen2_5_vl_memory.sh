#!/bin/bash
########## prepare env #########
# source scripts/finetune2/setup_env.sh
...
RUN_NAME=019-ablation_memory_qa_caption_question-aware_fixed_shot_duration_15s_full_video_2x16
OUTP_DIR=results
...
# --nnodes $WORLD_SIZE \
# python -m torch.distributed.launch $@ scripts/finetune/finetune_qwen2_5_vl.py \
...
torchrun --master_addr $MASTER_ADDR \
    ...
    --exp_desc 'use caption annotations, no visual pretrain, full video, fixed shot duration 15s.' \
