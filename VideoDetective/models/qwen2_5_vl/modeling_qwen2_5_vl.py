...
from models.qwen2_5_vl.configuration_qwen2_5_vl import Qwen2_5_VLConfig, Qwen2_5_VLVisionConfig
import numpy as np
import os
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        # print('pos_ids: ', position_ids,'   rope_delats: ',self.rope_deltas)
        ...
        # attns = outputs[-1]
        # token_dir = join(vis_dir,str(len(tokens)).zfill(3))
        # os.makedirs(token_dir,exist_ok=True)
        # file = f'layer_27.npy'
        # np.save(join(token_dir,file),attns[-1].to(torch.float32).cpu().data.numpy())
        
        # for layer_idx in range(len(attns)):
        #     file = f'layer_{layer_idx}.npy'
        #     np.save(join(token_dir,file),attns[layer_idx].to(torch.float32).cpu().data.numpy())  # 1, 28, q_len, kv_len
